...
function getCodeAnalizer(params) {
     ...
     */ const handleNewResponseExpression = (node)=>{
            ...
            if (isUserMiddlewareUserFile(parser.state.current) && firstParameter && !isNullLiteral(firstParameter) && !isUndefinedIdentifier(firstParameter)) {
...
function isUserMiddlewareUserFile(module) {
    return module.layer === 'middleware' && /middleware\.\w+$/.test(module.rawRequest);
}
