...
async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , hasReactRoot , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , runWebpackSpan , target ='server' , viewsDir  }) {
    var ref41, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref19, ref20, ref21, ref22, ref23;
    ...
    if (useSWCLoader) {
        var ref24, ref25, ref26;
        // TODO: we do not collect wasm target yet
        const binaryTarget = (ref24 = require('./swc')) === null || ref24 === void 0 ? void 0 : (ref25 = ref24.getBinaryMetadata) === null || ref25 === void 0 ? void 0 : (ref26 = ref25.call(ref24)) === null || ref26 === void 0 ? void 0 : ref26.target;
    ...
    const getBabelOrSwcLoader = ()=>{
        ...
        if (useSWCLoader && (config === null || config === void 0 ? void 0 : (ref = config.experimental) === null || ref === void 0 ? void 0 : ref.swcTraceProfiling)) {
            ...
            ref39, ref40;
            (ref39 = require('./swc')) === null || ref39 === void 0 ? void 0 : (ref40 = ref39.initCustomTraceSubscriber) === null || ref40 === void 0 ? void 0 : ref40.call(ref39, _path.default.join(distDir, `swc-trace-profile-${Date.now()}.json`));
        }
        return useSWCLoader ? {
    ...
    const clientEntries = isClient ? {
        ...
        ...config.experimental.viewsDir ? {
            [_constants1.CLIENT_STATIC_FILES_RUNTIME_MAIN_ROOT]: `./` + _path.default.relative(dir, _path.default.join(_constants.NEXT_PROJECT_ROOT_DIST_CLIENT, 'views-next.js')).replace(/\\/g, '/')
        } : {}
    } : undefined;
    ...
    const resolveConfig = {
        ...
        alias: {
            ...
            ...viewsDir ? {
                [_constants.VIEWS_DIR_ALIAS]: viewsDir
            } : {},
    ...
    const looseEsmExternals = ((ref41 = config.experimental) === null || ref41 === void 0 ? void 0 : ref41.esmExternals) === 'loose';
    ...
    let webpackConfig = {
        ...
        output: {
            ...
            filename: isNodeServer || isEdgeServer ? dev || isEdgeServer ? `[name].js` : `../[name].js` : `static/chunks/${isDevFallback ? 'fallback/' : ''}[name]${dev ? '' : '-[contenthash]'}.js`,
        ...
        plugins: [
            ...!dev && isEdgeServer && !!config.experimental.middlewareSourceMaps && !config.productionBrowserSourceMaps ? (0, _middlewareSourceMapsPlugin).getMiddlewareSourceMapPlugins() : [],
            ...
            new _webpack.webpack.DefinePlugin({
                ...
                'process.env.__NEXT_IMAGE_OPTS': JSON.stringify({
                    ...
                    ...dev ? {
                        ...
                        experimentalRemotePatterns: (ref3 = config.experimental) === null || ref3 === void 0 ? void 0 : (ref4 = ref3.images) === null || ref4 === void 0 ? void 0 : ref4.remotePatterns
                    } : {}
                }),
                'process.env.__NEXT_ROUTER_BASEPATH': JSON.stringify(config.basePath),
                'process.env.__NEXT_HAS_REWRITES': JSON.stringify(hasRewrites),
                'process.env.__NEXT_I18N_SUPPORT': JSON.stringify(!!config.i18n),
                'process.env.__NEXT_I18N_DOMAINS': JSON.stringify((ref5 = config.i18n) === null || ref5 === void 0 ? void 0 : ref5.domains),
          ...
          `
            ...
            config.outputFileTracing && !isLikeServerless && (isNodeServer || isEdgeServer) && !dev && new _nextTraceEntrypointsPlugin.TraceEntryPointsPlugin({
                appDir: dir,
            ...
            !dev && isClient && new _telemetryPlugin.TelemetryPlugin(new Map([
                [
                    'swcLoader',
                    useSWCLoader
                ],
                ...
                [
                    'swcRelay',
                    !!((ref6 = config.compiler) === null || ref6 === void 0 ? void 0 : ref6.relay)
                ],
                [
                    'swcStyledComponents',
                    !!((ref7 = config.compiler) === null || ref7 === void 0 ? void 0 : ref7.styledComponents)
                ],
                [
                    'swcReactRemoveProperties',
                    !!((ref8 = config.compiler) === null || ref8 === void 0 ? void 0 : ref8.reactRemoveProperties), 
                ],
                [
                    'swcExperimentalDecorators',
                    !!(jsConfig === null || jsConfig === void 0 ? void 0 : (ref9 = jsConfig.compilerOptions) === null || ref9 === void 0 ? void 0 : ref9.experimentalDecorators), 
                ],
                [
                    'swcRemoveConsole',
                    !!((ref10 = config.compiler) === null || ref10 === void 0 ? void 0 : ref10.removeConsole)
                ],
                [
                    'swcImportSource',
                    !!(jsConfig === null || jsConfig === void 0 ? void 0 : (ref11 = jsConfig.compilerOptions) === null || ref11 === void 0 ? void 0 : ref11.jsxImportSource)
                ],
                [
                    'swcEmotion',
    ...
    if (resolvedBaseUrl) {
        var ref27, ref28;
        (ref27 = webpackConfig.resolve) === null || ref27 === void 0 ? void 0 : (ref28 = ref27.modules) === null || ref28 === void 0 ? void 0 : ref28.push(resolvedBaseUrl);
    }
    if ((jsConfig === null || jsConfig === void 0 ? void 0 : (ref12 = jsConfig.compilerOptions) === null || ref12 === void 0 ? void 0 : ref12.paths) && resolvedBaseUrl) {
        var ref29, ref30;
        (ref29 = webpackConfig.resolve) === null || ref29 === void 0 ? void 0 : (ref30 = ref29.plugins) === null || ref30 === void 0 ? void 0 : ref30.unshift(new _jsconfigPathsPlugin.JsConfigPathsPlugin(jsConfig.compilerOptions.paths, resolvedBaseUrl));
    }
    const webpack5Config = webpackConfig;
    (ref13 = webpack5Config.module) === null || ref13 === void 0 ? void 0 : (ref14 = ref13.rules) === null || ref14 === void 0 ? void 0 : ref14.unshift({
        test: /\.wasm$/,
        issuerLayer: 'middleware',
    ...
    const configVars = JSON.stringify({
        ...
        removeConsole: (ref15 = config.compiler) === null || ref15 === void 0 ? void 0 : ref15.removeConsole,
        reactRemoveProperties: (ref16 = config.compiler) === null || ref16 === void 0 ? void 0 : ref16.reactRemoveProperties,
        styledComponents: (ref17 = config.compiler) === null || ref17 === void 0 ? void 0 : ref17.styledComponents,
        relay: (ref18 = config.compiler) === null || ref18 === void 0 ? void 0 : ref18.relay,
        emotion: (ref19 = config.experimental) === null || ref19 === void 0 ? void 0 : ref19.emotion,
        modularizeImports: (ref20 = config.experimental) === null || ref20 === void 0 ? void 0 : ref20.modularizeImports,
        legacyBrowsers: (ref21 = config.experimental) === null || ref21 === void 0 ? void 0 : ref21.legacyBrowsers
    });
    const cache = {
        type: 'filesystem',
        // Includes:
        ...
        version: `${"12.1.7-canary.10"}|${configVars}`,
    ...
    if (typeof config.webpack === 'function') {
        ...
        if (((ref31 = webpack5Config.experiments) === null || ref31 === void 0 ? void 0 : ref31.lazyCompilation) === true) {
            webpack5Config.experiments.lazyCompilation = {
                entries: false
            };
        } else if (typeof ((ref32 = webpack5Config.experiments) === null || ref32 === void 0 ? void 0 : ref32.lazyCompilation) === 'object' && webpack5Config.experiments.lazyCompilation.entries !== false) {
    ...
    if (!config.images.disableStaticImages) {
        var ref33;
        const rules = ((ref33 = webpackConfig.module) === null || ref33 === void 0 ? void 0 : ref33.rules) || [];
    ...
    if (config.experimental.craCompat && ((ref22 = webpackConfig.module) === null || ref22 === void 0 ? void 0 : ref22.rules) && webpackConfig.plugins) {
    ...
    var ref34;
    const hasUserCssConfig = (ref34 = (ref23 = webpackConfig.module) === null || ref23 === void 0 ? void 0 : ref23.rules.some((rule)=>canMatchCss(rule.test) || canMatchCss(rule.include)
    )) !== null && ref34 !== void 0 ? ref34 : false;
    if (hasUserCssConfig) {
        var ref35, ref36, ref37, ref38;
        ...
        if ((ref35 = webpackConfig.module) === null || ref35 === void 0 ? void 0 : ref35.rules.length) {
        ...
        if ((ref36 = webpackConfig.plugins) === null || ref36 === void 0 ? void 0 : ref36.length) {
            // Disable CSS Extraction Plugin
            webpackConfig.plugins = webpackConfig.plugins.filter((p)=>p.__next_css_remove !== true
            );
        }
        if ((ref37 = webpackConfig.optimization) === null || ref37 === void 0 ? void 0 : (ref38 = ref37.minimizer) === null || ref38 === void 0 ? void 0 : ref38.length) {
