...
const version = "12.1.7-canary.10";
...
const ViewRouterContext = /*#__PURE__*/ _react.default.createContext({});
// TODO: move to client component when handling is implemented
function ViewRouter({ initialUrl , children  }) {
    var ref;
    const initialState = {
        url: initialUrl
    };
    ...
    const viewRouter = _react.default.useMemo(()=>{
        return {
            push: (url)=>{
    ...
    return(/*#__PURE__*/ _react.default.createElement(ViewRouterContext.Provider, {
        value: viewRouter
    }, root ? root : children));
}
function hydrate() {
    renderReactElement(appElement, ()=>/*#__PURE__*/ _react.default.createElement(_react.default.StrictMode, null, /*#__PURE__*/ _react.default.createElement(Root, null, /*#__PURE__*/ _react.default.createElement(ViewRouter, {
...
//# sourceMappingURL=views-index.js.map