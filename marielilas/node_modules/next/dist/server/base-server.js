...
class Server {
    constructor(options){
        ...
        this.incrementalCache = new _incrementalCache.IncrementalCache({
            ...
            dev,
            distDir: this.distDir,
            pagesDir: (0, _path).join(this.serverDistDir, 'pages'),
    ...
    async handleRequest(req, res, parsedUrl) {
        try {
            ...
            if (this.minimalMode && req.headers['x-matched-path'] && typeof req.headers['x-matched-path'] === 'string') {
                ...
                let srcPathname = isDataUrl ? this.stripNextDataPath(((ref10 = parsedMatchedPath.pathname) === null || ref10 === void 0 ? void 0 : ref10.replace(/\.json$/, '')) || matchedPathnameNoExt) || '/' : matchedPathnameNoExt;
                ...
                if (!(0, _utils1).isDynamicRoute(srcPathname) && !this.hasPage(srcPathname)) {
   ...
   */ async handleApiRequest(req, res, pathname, query) {
    ...
    getViewPathRoutes() {
        const viewPathRoutes = {};
        Object.keys(this.viewPathsManifest || {}).forEach((entry)=>{
            viewPathRoutes[(0, _viewPaths).normalizeViewPath(entry)] = entry;
        });
        return viewPathRoutes;
    }
    getViewPathLayouts(pathname) {
        const layoutPaths = [];
    ...
    async renderToResponseWithComponents({ req , res , pathname , renderOpts: opts  }, { components , query  }) {
        ...
        const isDataReq = !!query._nextDataReq && (isSSG || hasServerProps || isServerComponent);
    ...
    async renderToResponse(ctx) {
        ...
        const getOriginalViewPath = (viewPath)=>{
            if (this.nextConfig.experimental.viewsDir) {
                var ref, ref21;
                const originalViewPath = ((ref = this.viewPathRoutes) === null || ref === void 0 ? void 0 : ref[`${viewPath}/index`]) || ((ref21 = this.viewPathRoutes) === null || ref21 === void 0 ? void 0 : ref21[`${viewPath}`]);
                if (!originalViewPath) {
                    return null;
                }
