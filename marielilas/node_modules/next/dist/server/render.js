...
function useFlightResponse({ id , req , pageData , inlinedDataWritable  }) {
...
function createServerComponentRenderer(App, Component, { cachePrefix , pageData , inlinedTransformStream , serverComponentManifest  }) {
...
async function renderToHTML(req, res, pathname, query, renderOpts) {
    ...
    if (renderServerComponentData) {
        ...
        }, true), serverComponentManifest).pipeThrough((0, _nodeWebStreamsHelper).createBufferedTransformStream()));
    }
    ...
    const renderDocument = async ()=>{
        ...
        const renderContent = (_App, _Component)=>{
            ...
            return ctx.err && ErrorDebug ? /*#__PURE__*/ _react.default.createElement(Body, null, /*#__PURE__*/ _react.default.createElement(ErrorDebug, {
                error: ctx.err
            })) : /*#__PURE__*/ _react.default.createElement(Body, null, /*#__PURE__*/ _react.default.createElement(AppContainerWithIsomorphicFiberStructure, null, renderPageTree(// AppServer is included in the EnhancedComponent in ServerComponentWrapper
            isServerComponent ? _react.default.Fragment : EnhancedApp, EnhancedComponent, {
