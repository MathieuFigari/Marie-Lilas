...
function getPagePath(page, distDir, serverless, dev, locales, rootEnabled) {
    ...
    if (rootEnabled) {
        ...
        rootPathsManifest = require((0, _path).join(serverBuildPath, _constants.VIEW_PATHS_MANIFEST));
    }
...
function requirePage(page, distDir, serverless, rootEnabled) {
    const pagePath = getPagePath(page, distDir, serverless, false, undefined, rootEnabled);
