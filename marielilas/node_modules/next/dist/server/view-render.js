...
function useFlightResponse(writable, id, req) {
...
function createServerComponentRenderer(ComponentToRender, ComponentMod, { cachePrefix , transformStream , serverComponentManifest  }) {
    ...
    if (ComponentMod.__next_view_webpack_require__ || ComponentMod.__next_rsc__) {
        // @ts-ignore
        globalThis.__webpack_require__ = ComponentMod.__next_view_webpack_require__ ? ComponentMod.__next_view_webpack_require__ : ComponentMod.__next_rsc__.__webpack_require__;
        // @ts-ignore
